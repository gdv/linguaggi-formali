...
\xspaceaddexceptions{\zero \uno \due \kleene}
...
\newcommand{\epsprod}{\ensuremath{\varepsilon}-produzioni\xspace}
...
\newcommand{\nfa}{\ensuremath{\mathcal{A}=\langle \Sigma, Q, q_{0}, F, \delta \rangle}\xspace}
\newcommand{\enfa}{ε-NFA\xspace}
\newcommand{\pda}{\ensuremath{\mathcal{A}=\langle \Sigma, \Gamma, Z_{0}, Q, q_{0}, F, \delta \rangle}\xspace}
\newcommand{\mdt}{\ensuremath{\mathcal{M}=\langle Q, q_{0}, F, \Gamma, \delta \rangle}\xspace}

% Parser
\newcommand{\idp}[4]{\begin{tabular}{r|l}\midrule{}#1&#2\\\midrule{}#3&#4\\\midrule\end{tabular}}
...
\newcommand{\lepo}[1]{\todo[backgroundcolor=orange]{\textbf{AL} #1}}
...
\renewcommand{\ExerciseHeader}{\noindent\textbf{Esercizio~\ExerciseHeaderNB}.\xspace}
\renewcommand{\AnswerHeader}{\noindent\textbf{Soluzione all'Esercizio~\ExerciseHeaderNB}.\xspace}
