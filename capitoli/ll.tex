...
L'efficienza pratica della discesa ricorsiva è dovuta al fatto che ogni produzione il cui corpo inizia con un
...
Se permettiamo di espandere solo produzioni la cui testa inizia con il simbolo attuale dell'input, limitiamo
...
testa e il cui corporation's inizia con il terminale.
...
Inoltre la tabella $TP$ deve contenere solo il membro destro della produzione, in quanto la testa è la
variabile $A$.
...
$\First(\alpha_{i})$ per tutte i membri destri delle produzioni che hanno $A$ come testa.
In altre parole, se $A\to \alpha_{1},\ldots, \alpha_{n}$ sono tutte le produzioni che hanno $A$ come testa,
